...
export const en = {
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "codexAuth.mainLoginButton": "Log in",
  "codexAuth.mainLoginTitle": "Log in to the main account",
  "codexAuth.mainLoginDesc": "Complete the official Codex device login in your browser. The server will update the main account after it finishes.",
  "codexAuth.mainLoginPreparing": "Preparing a secure login session…",
  "codexAuth.mainLoginCodeLabel": "One-time device code",
  "codexAuth.mainLoginCopyCode": "Copy code",
  "codexAuth.mainLoginCodeCopied": "Code copied",
  "codexAuth.mainLoginCodeCopyUnavailable": "Copy unavailable",
  "codexAuth.mainLoginSafetyHint": "Only enter this code on the official OpenAI login page you opened for this session.",
  "codexAuth.mainLoginActivating": "Login complete. Safely updating the main account…",
  "codexAuth.mainLoginSuccess": "Main account login updated. Refreshing account status…",
  "codexAuth.mainLoginFailed": "Main account login failed.",
  ...
  "codexAuth.subscriptionLabel": "Plus subscription",
  "codexAuth.subscriptionExpires": "expires {date}",
  "codexAuth.subscriptionExpired": "expired {date}",
  "codexAuth.subscriptionUnknown": "expiry not available",
  "codexAuth.subscriptionLookupFailed": "lookup failed; last known value kept",
  "codexAuth.refreshSubscription": "Refresh expiry",
  "codexAuth.refreshingSubscription": "Refreshing expiry...",
  "codexAuth.refreshSubscriptionAria": "Refresh Plus expiry for {account}",
  "codexAuth.subscriptionRefreshed": "Plus expiry refreshed",
  "codexAuth.subscriptionRefreshFailed": "Could not refresh Plus expiry",
  "codexAuth.refreshAllSubscriptions": "Refresh all expiries",
  "codexAuth.refreshingAllSubscriptions": "Refreshing all expiries...",
  "codexAuth.subscriptionRefreshAllSucceeded": "Plus expiry refreshed for {count} accounts",
  "codexAuth.subscriptionRefreshAllPartial": "Plus expiry refreshed: {succeeded} succeeded, {failed} failed",
  "codexAuth.subscriptionRefreshAllNone": "No signed-in accounts to refresh",
  "codexAuth.subscriptionRefreshAllFailed": "Could not refresh Plus expiries",
  "codexAuth.usage7dLabel": "Last 7 days API list-price equivalent",
  "codexAuth.usage7dRequests": "{count} requests",
  "codexAuth.usage7dIncomplete": "{count} requests not priced",
  "codexAuth.usage7dTruncated": "available history only",
  "codexAuth.usage7dDisclaimer": "API list-price equivalent for traffic served by this account; not an actual ChatGPT Plus charge.",
  "codexAuth.weeklyCapacityLabel": "Estimated 7-day capacity",
  "codexAuth.weeklyCapacityCollecting": "Collecting ({pct}% used; shown from 5%)",
  "codexAuth.weeklyCapacityDetail": "{observed} observed at {pct}% used · {remaining} estimated remaining · {confidence} confidence",
  "codexAuth.weeklyCapacityConfidenceLow": "low",
  "codexAuth.weeklyCapacityConfidenceMedium": "medium",
  "codexAuth.weeklyCapacityConfidenceHigh": "high",
  "codexAuth.weeklyCapacityDisclaimer": "API list-price equivalent estimated from this account's current seven-day percentage and traffic served by OpenCodex; not a ChatGPT bill or guaranteed allowance.",
