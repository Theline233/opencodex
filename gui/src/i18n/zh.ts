...
export const zh: Record<TKey, string> = {
  ...
  "codexAuth.mainLoginButton": "登录主账号",
  "codexAuth.mainLoginTitle": "登录主账号",
  "codexAuth.mainLoginDesc": "在浏览器中完成官方 Codex 设备登录，完成后服务器会更新主账号。",
  "codexAuth.mainLoginPreparing": "正在准备安全登录会话…",
  "codexAuth.mainLoginCodeLabel": "一次性设备验证码",
  "codexAuth.mainLoginCopyCode": "复制验证码",
  "codexAuth.mainLoginCodeCopied": "验证码已复制",
  "codexAuth.mainLoginCodeCopyUnavailable": "暂时无法复制",
  "codexAuth.mainLoginSafetyHint": "只在本次登录打开的官方 OpenAI 页面中输入此验证码。",
  "codexAuth.mainLoginActivating": "登录完成，正在安全更新主账号…",
  "codexAuth.mainLoginSuccess": "主账号登录已更新，正在刷新账号状态…",
  "codexAuth.mainLoginFailed": "主账号登录失败。",
  ...
  "codexAuth.subscriptionLabel": "Plus 订阅",
  "codexAuth.subscriptionExpires": "到期时间 {date}",
  "codexAuth.subscriptionExpired": "已于 {date} 过期",
  "codexAuth.subscriptionUnknown": "暂未获取到期时间",
  "codexAuth.subscriptionLookupFailed": "查询失败，已保留上次结果",
  "codexAuth.refreshSubscription": "刷新到期时间",
  "codexAuth.refreshingSubscription": "正在刷新到期时间...",
  "codexAuth.refreshSubscriptionAria": "刷新 {account} 的 Plus 到期时间",
  "codexAuth.subscriptionRefreshed": "Plus 到期时间已刷新",
  "codexAuth.subscriptionRefreshFailed": "无法刷新 Plus 到期时间",
  "codexAuth.refreshAllSubscriptions": "刷新全部到期时间",
  "codexAuth.refreshingAllSubscriptions": "正在刷新全部到期时间...",
  "codexAuth.subscriptionRefreshAllSucceeded": "已刷新 {count} 个账号的 Plus 到期时间",
  "codexAuth.subscriptionRefreshAllPartial": "Plus 到期时间刷新完成：成功 {succeeded} 个，失败 {failed} 个",
  "codexAuth.subscriptionRefreshAllNone": "没有已登录且可刷新的账号",
  "codexAuth.subscriptionRefreshAllFailed": "无法批量刷新 Plus 到期时间",
  "codexAuth.usage7dLabel": "近 7 天 API 标价等价值",
  "codexAuth.usage7dRequests": "{count} 次请求",
  "codexAuth.usage7dIncomplete": "{count} 次无法估价",
  "codexAuth.usage7dTruncated": "仅统计可用历史",
  "codexAuth.usage7dDisclaimer": "按该账号实际承载流量和 API 标价估算，并非 ChatGPT Plus 实际扣费。",
  "codexAuth.weeklyCapacityLabel": "七天周期总额估算",
  "codexAuth.weeklyCapacityCollecting": "采集中（当前已用 {pct}%，达到 5% 后显示）",
  "codexAuth.weeklyCapacityDetail": "已观测 {observed} / 已用 {pct}% · 预估剩余 {remaining} · {confidence}可信度",
  ...
  "codexAuth.weeklyCapacityDisclaimer": "按该账号当前七天额度百分比和 OpenCodex 承载流量的 API 标价等价值估算；不是实际账单或官方承诺额度。",
