...
export const ja: Record<TKey, string> = {
  ...
  "codexAuth.mainLoginButton": "ログイン",
  "codexAuth.mainLoginTitle": "メインアカウントにログイン",
  "codexAuth.mainLoginDesc": "ブラウザで公式 Codex デバイスログインを完了してください。完了後、サーバーがメインアカウントを更新します。",
  "codexAuth.mainLoginPreparing": "安全なログインセッションを準備しています…",
  "codexAuth.mainLoginCodeLabel": "1 回限りのデバイスコード",
  "codexAuth.mainLoginCopyCode": "コードをコピー",
  "codexAuth.mainLoginCodeCopied": "コードをコピーしました",
  "codexAuth.mainLoginCodeCopyUnavailable": "コピーできません",
  "codexAuth.mainLoginSafetyHint": "このコードは、このセッションで開いた公式 OpenAI ログインページにのみ入力してください。",
  "codexAuth.mainLoginActivating": "ログイン完了。メインアカウントを安全に更新しています…",
  "codexAuth.mainLoginSuccess": "メインアカウントを更新しました。ステータスを更新しています…",
  "codexAuth.mainLoginFailed": "メインアカウントのログインに失敗しました。",
  ...
  "codexAuth.subscriptionLabel": "Plus サブスクリプション",
  "codexAuth.subscriptionExpires": "{date} に期限切れ",
  "codexAuth.subscriptionExpired": "{date} に期限切れ済み",
  "codexAuth.subscriptionUnknown": "有効期限を取得できません",
  "codexAuth.subscriptionLookupFailed": "取得に失敗しました。前回の値を保持します",
  "codexAuth.refreshSubscription": "有効期限を更新",
  "codexAuth.refreshingSubscription": "有効期限を更新中...",
  "codexAuth.refreshSubscriptionAria": "{account} の Plus 有効期限を更新",
  "codexAuth.subscriptionRefreshed": "Plus 有効期限を更新しました",
  "codexAuth.subscriptionRefreshFailed": "Plus 有効期限を更新できませんでした",
  "codexAuth.refreshAllSubscriptions": "すべての有効期限を更新",
  "codexAuth.refreshingAllSubscriptions": "すべての有効期限を更新中...",
  "codexAuth.subscriptionRefreshAllSucceeded": "{count} 件の Plus 有効期限を更新しました",
  "codexAuth.subscriptionRefreshAllPartial": "Plus 有効期限の更新完了: 成功 {succeeded} 件、失敗 {failed} 件",
  "codexAuth.subscriptionRefreshAllNone": "更新できるログイン済みアカウントがありません",
  "codexAuth.subscriptionRefreshAllFailed": "Plus 有効期限を一括更新できませんでした",
  "codexAuth.usage7dLabel": "直近7日間のAPI定価相当額",
  "codexAuth.usage7dRequests": "{count} 件のリクエスト",
  "codexAuth.usage7dIncomplete": "{count} 件は価格未算定",
  "codexAuth.usage7dTruncated": "利用可能な履歴のみ",
  "codexAuth.usage7dDisclaimer": "このアカウントが処理したトラフィックのAPI定価相当額であり、ChatGPT Plusの実請求額ではありません。",
  "codexAuth.weeklyCapacityLabel": "7日間容量の推定",
  "codexAuth.weeklyCapacityCollecting": "収集中（現在 {pct}% 使用、5%から表示）",
  "codexAuth.weeklyCapacityDetail": "{pct}% 使用時点で {observed} を観測 · 残り推定 {remaining} · 信頼度 {confidence}",
  "codexAuth.weeklyCapacityConfidenceLow": "低",
  "codexAuth.weeklyCapacityConfidenceMedium": "中",
  "codexAuth.weeklyCapacityConfidenceHigh": "高",
  "codexAuth.weeklyCapacityDisclaimer": "このアカウントの現在の7日間使用率とOpenCodexが処理したトラフィックから算出したAPI定価相当の推定値です。請求額や保証された上限ではありません。",
