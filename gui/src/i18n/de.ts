...
export const de: Record<TKey, string> = {
  ...
  "codexAuth.mainLoginButton": "Anmelden",
  "codexAuth.mainLoginTitle": "Beim Hauptkonto anmelden",
  "codexAuth.mainLoginDesc": "Schließen Sie die offizielle Codex-Geräteanmeldung im Browser ab. Danach aktualisiert der Server das Hauptkonto.",
  "codexAuth.mainLoginPreparing": "Sichere Anmeldung wird vorbereitet …",
  "codexAuth.mainLoginCodeLabel": "Einmaliger Gerätecode",
  "codexAuth.mainLoginCopyCode": "Code kopieren",
  "codexAuth.mainLoginCodeCopied": "Code kopiert",
  "codexAuth.mainLoginCodeCopyUnavailable": "Kopieren nicht verfügbar",
  "codexAuth.mainLoginSafetyHint": "Geben Sie diesen Code nur auf der offiziellen OpenAI-Anmeldeseite dieser Sitzung ein.",
  "codexAuth.mainLoginActivating": "Anmeldung abgeschlossen. Hauptkonto wird sicher aktualisiert …",
  "codexAuth.mainLoginSuccess": "Hauptkonto aktualisiert. Kontostatus wird geladen …",
  "codexAuth.mainLoginFailed": "Anmeldung des Hauptkontos fehlgeschlagen.",
  ...
  "codexAuth.subscriptionLabel": "Plus-Abonnement",
  "codexAuth.subscriptionExpires": "läuft am {date} ab",
  "codexAuth.subscriptionExpired": "am {date} abgelaufen",
  "codexAuth.subscriptionUnknown": "Ablaufdatum nicht verfügbar",
  "codexAuth.subscriptionLookupFailed": "Abfrage fehlgeschlagen; letzter Wert bleibt erhalten",
  "codexAuth.refreshSubscription": "Ablauf aktualisieren",
  "codexAuth.refreshingSubscription": "Ablauf wird aktualisiert...",
  "codexAuth.refreshSubscriptionAria": "Plus-Ablauf für {account} aktualisieren",
  "codexAuth.subscriptionRefreshed": "Plus-Ablauf aktualisiert",
  "codexAuth.subscriptionRefreshFailed": "Plus-Ablauf konnte nicht aktualisiert werden",
  "codexAuth.refreshAllSubscriptions": "Alle Ablaufdaten aktualisieren",
  "codexAuth.refreshingAllSubscriptions": "Alle Ablaufdaten werden aktualisiert...",
  "codexAuth.subscriptionRefreshAllSucceeded": "Plus-Ablauf für {count} Konten aktualisiert",
  "codexAuth.subscriptionRefreshAllPartial": "Plus-Ablauf aktualisiert: {succeeded} erfolgreich, {failed} fehlgeschlagen",
  "codexAuth.subscriptionRefreshAllNone": "Keine angemeldeten Konten zum Aktualisieren",
  "codexAuth.subscriptionRefreshAllFailed": "Plus-Ablaufdaten konnten nicht aktualisiert werden",
  "codexAuth.usage7dLabel": "API-Listenpreiswert der letzten 7 Tage",
  "codexAuth.usage7dRequests": "{count} Anfragen",
  "codexAuth.usage7dIncomplete": "{count} Anfragen ohne Preis",
  "codexAuth.usage7dTruncated": "nur verfügbarer Verlauf",
  "codexAuth.usage7dDisclaimer": "API-Listenpreiswert für den Datenverkehr dieses Kontos; keine tatsächliche ChatGPT-Plus-Belastung.",
  "codexAuth.weeklyCapacityLabel": "Geschätzte 7-Tage-Kapazität",
  "codexAuth.weeklyCapacityCollecting": "Datenerfassung ({pct}% genutzt; Anzeige ab 5%)",
  "codexAuth.weeklyCapacityDetail": "{observed} bei {pct}% Nutzung erfasst · geschätzt {remaining} verbleibend · Konfidenz {confidence}",
  "codexAuth.weeklyCapacityConfidenceLow": "niedrig",
  "codexAuth.weeklyCapacityConfidenceMedium": "mittel",
  "codexAuth.weeklyCapacityConfidenceHigh": "hoch",
  "codexAuth.weeklyCapacityDisclaimer": "API-Listenpreis-Schätzung aus dem aktuellen 7-Tage-Prozentsatz dieses Kontos und dem von OpenCodex verarbeiteten Datenverkehr; keine Rechnung oder garantierte Zuteilung.",
