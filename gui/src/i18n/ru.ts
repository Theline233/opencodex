...
export const ru: Record<TKey, string> = {
  ...
  "codexAuth.mainLoginButton": "Войти",
  "codexAuth.mainLoginTitle": "Вход в основной аккаунт",
  "codexAuth.mainLoginDesc": "Завершите официальный вход Codex по коду устройства в браузере. После этого сервер обновит основной аккаунт.",
  "codexAuth.mainLoginPreparing": "Подготовка безопасного входа…",
  "codexAuth.mainLoginCodeLabel": "Одноразовый код устройства",
  "codexAuth.mainLoginCopyCode": "Копировать код",
  "codexAuth.mainLoginCodeCopied": "Код скопирован",
  "codexAuth.mainLoginCodeCopyUnavailable": "Копирование недоступно",
  "codexAuth.mainLoginSafetyHint": "Вводите этот код только на официальной странице входа OpenAI, открытой для этой сессии.",
  "codexAuth.mainLoginActivating": "Вход завершён. Безопасно обновляем основной аккаунт…",
  "codexAuth.mainLoginSuccess": "Основной аккаунт обновлён. Обновляем его статус…",
  "codexAuth.mainLoginFailed": "Не удалось войти в основной аккаунт.",
  ...
  "codexAuth.subscriptionLabel": "Подписка Plus",
  "codexAuth.subscriptionExpires": "истекает {date}",
  "codexAuth.subscriptionExpired": "истекла {date}",
  "codexAuth.subscriptionUnknown": "срок действия недоступен",
  "codexAuth.subscriptionLookupFailed": "запрос не удался; сохранено последнее значение",
  "codexAuth.refreshSubscription": "Обновить срок",
  "codexAuth.refreshingSubscription": "Обновление срока...",
  "codexAuth.refreshSubscriptionAria": "Обновить срок Plus для {account}",
  "codexAuth.subscriptionRefreshed": "Срок Plus обновлён",
  "codexAuth.subscriptionRefreshFailed": "Не удалось обновить срок Plus",
  "codexAuth.refreshAllSubscriptions": "Обновить все сроки",
  "codexAuth.refreshingAllSubscriptions": "Обновление всех сроков...",
  "codexAuth.subscriptionRefreshAllSucceeded": "Срок Plus обновлён для аккаунтов: {count}",
  "codexAuth.subscriptionRefreshAllPartial": "Сроки Plus обновлены: успешно {succeeded}, ошибок {failed}",
  "codexAuth.subscriptionRefreshAllNone": "Нет авторизованных аккаунтов для обновления",
  "codexAuth.subscriptionRefreshAllFailed": "Не удалось обновить сроки Plus",
  "codexAuth.usage7dLabel": "Эквивалент по API-тарифу за 7 дней",
  "codexAuth.usage7dRequests": "запросов: {count}",
  "codexAuth.usage7dIncomplete": "без оценки: {count}",
  "codexAuth.usage7dTruncated": "только доступная история",
  "codexAuth.usage7dDisclaimer": "Эквивалент по API-тарифу для трафика этого аккаунта, а не фактическое списание ChatGPT Plus.",
  "codexAuth.weeklyCapacityLabel": "Оценка ёмкости на 7 дней",
  "codexAuth.weeklyCapacityCollecting": "Сбор данных ({pct}% использовано; показ с 5%)",
  "codexAuth.weeklyCapacityDetail": "Наблюдалось {observed} при {pct}% · оценка остатка {remaining} · уверенность: {confidence}",
  "codexAuth.weeklyCapacityConfidenceLow": "низкая",
  "codexAuth.weeklyCapacityConfidenceMedium": "средняя",
  "codexAuth.weeklyCapacityConfidenceHigh": "высокая",
  "codexAuth.weeklyCapacityDisclaimer": "Оценка по API-тарифу из текущего семидневного процента аккаунта и трафика OpenCodex; не счёт и не гарантированный лимит.",
