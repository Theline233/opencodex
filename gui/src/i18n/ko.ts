...
export const ko: Record<TKey, string> = {
  ...
  "codexAuth.mainLoginButton": "로그인",
  "codexAuth.mainLoginTitle": "메인 계정 로그인",
  "codexAuth.mainLoginDesc": "브라우저에서 공식 Codex 디바이스 로그인을 완료하세요. 완료되면 서버가 메인 계정을 업데이트합니다.",
  "codexAuth.mainLoginPreparing": "안전한 로그인 세션을 준비하는 중…",
  "codexAuth.mainLoginCodeLabel": "일회용 디바이스 코드",
  "codexAuth.mainLoginCopyCode": "코드 복사",
  "codexAuth.mainLoginCodeCopied": "코드가 복사되었습니다",
  "codexAuth.mainLoginCodeCopyUnavailable": "복사할 수 없음",
  "codexAuth.mainLoginSafetyHint": "이 세션에서 연 공식 OpenAI 로그인 페이지에만 이 코드를 입력하세요.",
  "codexAuth.mainLoginActivating": "로그인 완료. 메인 계정을 안전하게 업데이트하는 중…",
  "codexAuth.mainLoginSuccess": "메인 계정이 업데이트되었습니다. 상태를 새로 고치는 중…",
  "codexAuth.mainLoginFailed": "메인 계정 로그인에 실패했습니다.",
  ...
  "codexAuth.subscriptionLabel": "Plus 구독",
  "codexAuth.subscriptionExpires": "{date} 만료",
  "codexAuth.subscriptionExpired": "{date}에 만료됨",
  "codexAuth.subscriptionUnknown": "만료일을 확인할 수 없음",
  "codexAuth.subscriptionLookupFailed": "조회 실패; 마지막 값을 유지함",
  "codexAuth.refreshSubscription": "만료일 새로고침",
  "codexAuth.refreshingSubscription": "만료일 새로고침 중...",
  "codexAuth.refreshSubscriptionAria": "{account}의 Plus 만료일 새로고침",
  "codexAuth.subscriptionRefreshed": "Plus 만료일 새로고침 완료",
  "codexAuth.subscriptionRefreshFailed": "Plus 만료일을 새로고침할 수 없음",
  "codexAuth.refreshAllSubscriptions": "모든 만료일 새로고침",
  "codexAuth.refreshingAllSubscriptions": "모든 만료일 새로고침 중...",
  "codexAuth.subscriptionRefreshAllSucceeded": "{count}개 계정의 Plus 만료일을 새로고침함",
  "codexAuth.subscriptionRefreshAllPartial": "Plus 만료일 새로고침 완료: 성공 {succeeded}개, 실패 {failed}개",
  "codexAuth.subscriptionRefreshAllNone": "새로고침할 로그인 계정이 없음",
  "codexAuth.subscriptionRefreshAllFailed": "Plus 만료일을 일괄 새로고침할 수 없음",
  "codexAuth.usage7dLabel": "최근 7일 API 정가 환산액",
  "codexAuth.usage7dRequests": "요청 {count}건",
  "codexAuth.usage7dIncomplete": "가격 미산정 {count}건",
  "codexAuth.usage7dTruncated": "사용 가능한 기록만 집계",
  "codexAuth.usage7dDisclaimer": "이 계정이 처리한 트래픽의 API 정가 환산액이며 실제 ChatGPT Plus 청구액이 아닙니다.",
  "codexAuth.weeklyCapacityLabel": "7일 용량 추정",
  "codexAuth.weeklyCapacityCollecting": "수집 중(현재 {pct}% 사용, 5%부터 표시)",
  "codexAuth.weeklyCapacityDetail": "{pct}% 사용 시 {observed} 관측 · 예상 잔여 {remaining} · 신뢰도 {confidence}",
  "codexAuth.weeklyCapacityConfidenceLow": "낮음",
  "codexAuth.weeklyCapacityConfidenceMedium": "보통",
  "codexAuth.weeklyCapacityConfidenceHigh": "높음",
  "codexAuth.weeklyCapacityDisclaimer": "이 계정의 현재 7일 사용률과 OpenCodex가 처리한 트래픽으로 계산한 API 정가 환산 추정치이며 실제 청구액이나 보장된 한도가 아닙니다.",
